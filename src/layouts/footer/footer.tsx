      ...
      <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
        <div className="mx-auto max-w-sm lg:max-w-none">
          <p className="mt-4 text-center text-white lg:text-left lg:text-lg">
            Retrowiki es un sitio web dedicado a la nostalgia de los videojuegos
            que han marcado historia en nuestros corazones. Buscamos que los
            usuarios puedan encontrar información de los juegos y a la vez se
            puedan compartir los trucos que tanto nos han ayudado a pasar esos
            niveles difíciles.
          </p>
